...
const EditAppointment="UPDATE appointments SET doctor_id = $1,schedule_id = $2,appointment_date = s.date,appointment_time = s.hour FROM schedules s WHERE appointments.appointment_id = $3 AND appointments.patient_id = $4 AND s.schedule_id = $2"
module.exports={
    CreateAppointment,
    ShowAppointment,
    EditAppointment
