...
const EditAppointment="UPDATE appointments SET doctor_id = $1,schedule_id = $2 FROM schedules s WHERE appointments.appointment_id = $3 AND appointments.patient_id = $4 AND appointments.schedule_id = s.schedule_id  AND s.reserved = false"
module.exports={
    CreateAppointment,
    ShowAppointment,
    EditAppointment
