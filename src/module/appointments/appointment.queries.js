...
const ShowAppointment="SELECT a.appointment_id, a.appointment_date,a.appointment_time,u.name AS doctor_name FROM appointments a JOIN users u ON a.doctor_id = u.id WHERE a.patient_id =$1;"
