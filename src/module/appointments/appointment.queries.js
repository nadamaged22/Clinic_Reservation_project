...
const ShowAppointment="SELECT a.appointment_id,a.patient_id,d.doctor_id,u.name AS doctor_name FROM appointments a JOIN doctors d ON a.doctor_id = d.doctor_id JOIN users u ON d.user_id = u.id WHERE a.patient_id =$1";
